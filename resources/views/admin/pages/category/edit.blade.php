        ...
        <div class="card-body" style="background-color:gray; padding:5px">
          <form action="{{ route('admin/category/update', $category->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="title" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$category->name}}">
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Description</label>
              <textarea name="description" rows="8" cols="80" class="form-control" placeholder="Enter Your Product Description">{{$category->description}}</textarea>
           ...
           <div class="row">
             ...
             <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="row py-2">
                  <div class="col-md-12">
                  <img style="width:150px" src="{{asset('assets/categoryImage/'.$category->image)}}" alt="">
                  </div>
                </div> 
              </div>
             </div>
