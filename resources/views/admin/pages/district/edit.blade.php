        ...
        <div class="card-body" style="background-color:gray; padding:5px">
          <form action="{{ route('admin/district/update', $district->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="title" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$district->name}}">
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Priority Number</label>
              <input name="priority" rows="8" cols="80" class="form-control" placeholder="Enter Your Priority Number" value="{{$district->priority}}"></input>
