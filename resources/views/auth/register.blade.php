            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="district_id" class="col-md-4 col-form-label text-md-end">{{ __('Upazila') }}</label>
...
<script src="{{asset('js/jquery-3.6.0.min.js')}}"></script>
    <script>
        ...
        // send an ajax request to server with this division
            $.get( "http://localhost/IntershipLaravel/ecommerceProject/public/get-districts/"+division, 
    ...
    <script>
          $("#district-area").change(function(){
            ...
            var option = "";
            // send an ajax request to server with this division
            $.get( "http://localhost/IntershipLaravel/ecommerceProject/public/get-upazilas/"+district, 
            function( data ) {
