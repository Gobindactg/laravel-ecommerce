...
<div class="container ">
  <div class="row ">
    <div class="col-md-4">
      ...
      <h4 class="text-center text-info "> WELCOME <br> {{$user->first_name}}  {{$user->last_name}}</h4>
      </div>
        <div class="card-body">
            @php
            ...
            @endphp
              <a href="{{route('profile', $users_id)}}" title="Change Image"><img src="{{asset('assets/userImage/default/user.png')}}" class="image image-rounded" style="width:250px" ></a>
            @php
              }else{
            @endphp
              <a href="{{route('profile', $users_id)}}" title="Change Image"><img src="{{asset('assets/userImage/' . $users_avatar)}}" class="image image-rounded" style="width:100%" ></a>
            @php
              }
          @endphp<br> --}}
      ...
      <a href="{{route('profile', $users_id)}}" class="btn btn-primary my-2">Update Image</a>
    </div>
  </div>
  </div>
    <div class="col-md-8">
